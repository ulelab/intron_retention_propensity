#!/bin/bash
#SBATCH --job-name=clippy_rbpnet_250
#SBATCH --output=clippy_rbpnet_250_%A_%a.out
#SBATCH --error=clippy_rbpnet_250_%A_%a.err
...
BED=/scratch/prj/ppn_rnp_networks/users/mike.jones/data/rbpnet/split_beds/f250/${CHR}
...
OUTDIR=/scratch/prj/ppn_rnp_networks/users/mike.jones/data/rbpnet/peaks/f250/
OUTPREFIX=${OUTDIR}/rbpnet_clippy_f250_${CHR}

#!/bin/bash
#SBATCH --job-name=clippy_rbpnet_array
#SBATCH --output=clippy_rbpnet_array_%A_%a.out
#SBATCH --error=clippy_rbpnet_array_%A_%a.err
...
BED=/scratch/prj/ppn_rnp_networks/users/mike.jones/data/rbpnet/split_beds/f6584/${CHR}
...
OUTDIR=/scratch/prj/ppn_rnp_networks/users/mike.jones/data/rbpnet/peaks
OUTPREFIX=${OUTDIR}/rbpnet_clippy_${CHR}

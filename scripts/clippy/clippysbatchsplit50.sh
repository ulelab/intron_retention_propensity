#!/bin/bash
#SBATCH --job-name=clippy_rbpnet_50
#SBATCH --output=clippy_rbpnet_50_%A_%a.out
#SBATCH --error=clippy_rbpnet_50_%A_%a.err
...
BED=/scratch/prj/ppn_rnp_networks/users/mike.jones/data/rbpnet/split_beds/f50/${CHR}
...
OUTDIR=/scratch/prj/ppn_rnp_networks/users/mike.jones/data/rbpnet/peaks/f50/
OUTPREFIX=${OUTDIR}/rbpnet_clippy_f50_${CHR}
